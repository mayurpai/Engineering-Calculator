      ...
      <main className="min-h-screen flex flex-col py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto w-full">
          ...
          <div className="ui-card p-8 ui-reveal" onKeyDown={handleEnterPress}>
            ...
            {sgpa !== null && (
              <div ref={resultSectionRef} className="mt-8 p-6 bg-gradient-to-r from-blue-500/15 to-cyan-500/15 rounded-lg border border-cyan-300/35 ui-reveal ui-delay-1">
                ...
                <p className="text-4xl sm:text-5xl md:text-6xl !font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-cyan-300 ui-number">
                  {animatedSGPA.toFixed(2)}
                </p>
                <p className="text-slate-300 mt-6 mb-2">Converted Percentage ({percentageSchemeLabel})</p>
                <p className="text-3xl sm:text-4xl md:text-5xl !font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-cyan-300 ui-number">
